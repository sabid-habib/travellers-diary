...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Sites
                    <small>Manage Information About Sites</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="img/s3.jpg" alt="">
                </a>
                </div>
        </div>
        <!-- /.row -->
	...
	<script src="js/site.js" ></script>
        ...
        <div id="addform">
            ...
            <div class="row">
                <input type="text" id="site_type" name= "site_type"  placeholder="Site Type" />
            </div>
