...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Travel Agencies 
                    <small>Manage Agency Information</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
	...
	<script src="js/agency.js" ></script>
        ...
        <div id="addform">
            ...
            <div class="row">
                <input type="text" id="agency_name" name="agency_name" placeholder="Agency Name" />
            </div>

            <div class="row">
                <input type="text" id="agency_owner" name="agency_owner" placeholder="Agency_owner" />
            </div>

            <div class="row">
                <input type="text" id="trd_id" name="trd_id" placeholder="Trade Licence ID" />
            </div>
            
            <div class="row">
                <input type="text" id="bnk_drf" name="bnk_drf" placeholder="Bank Draft No" />
            </div>
            
            <div class="row">
                Validity From: <br> <input type="date" id="val_frm" name="val_frm"  />
            </div>
            
            <div class="row">
                Validity Till: <br><input type="date" id="val_to" name="val_to"  />
            </div>
