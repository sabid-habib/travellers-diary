...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Transportation
                    <small>Manage transportation Information</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
    ...
    <script src="js/transportation.js" ></script>
        ...
        <div id="addform">
            ...
            <div class="row">
                <input type="text" id="transport_type" name= "transport_type" placeholder="Transport Type" />
            </div>

            <div class="row">
                <input type="text" id="from_site" name= "from_site"  placeholder="Starts From" />
            </div>

            <div class="row">
                <input type="text" id="to_site" name= "to_site"  placeholder="Arrives In" />
            </div>
