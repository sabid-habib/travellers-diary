...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Resturants 
                    <small>Manage Resturant Information</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="img/f2.jpg" alt="">
                </a>
                </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="img/f3.jpg" alt="">
                </a>
                </div>
        </div>
        <!-- /.row -->
	...
	<script src="js/resturant.js" ></script>
        ...
        <div id="addform">
            ...
            <div class="row">
                <input type="text" id="rest_name" name= "rest_name" placeholder="Resturant Name" />
            </div>

            <div class="row">
                <input type="text" id="rest_type" name= "rest_type"  placeholder="Resturant Type" />
            </div>
