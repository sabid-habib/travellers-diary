...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Accomodation
                    <small>Manage Hotel/Resort Information</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-4 portfolio-item">
                <a href="agency.php">
                    <img class="img-responsive" src="img/h1.jpg" alt="">
                </a>
                </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="img/h2.jpg" alt="">
                </a>
                </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
	...
	<script src="js/accomodation.js" ></script>
        ...
        <div id="addform">
            ...
            <div class="row">
                <input type="text" id="accom_name" name= "accom_name" placeholder="Accomodation Name" />
            </div>

            <div class="row">
                <input type="text" id="accom_type" name= "accom_type"  placeholder="Accomodation Type" />
            </div>
