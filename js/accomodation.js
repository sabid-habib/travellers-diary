...
{ 
	this.editableGrid = new EditableGrid("accomodation", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadXML("loaddata_accomodation.php");
};
