...
{ 
	this.editableGrid = new EditableGrid("resturant", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadXML("loaddata_resturant.php");
};
