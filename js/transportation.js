...
{      
	$.ajax({
		...
		type: 'POST',
		dataType: "html",
		// var rowData = jQuery(this).getRowData(rowIndex);
		// var temp= rowData['ID'];
		data: {
...
{ 
	this.editableGrid = new EditableGrid("transport", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadXML("loaddata_transport.php");
};
